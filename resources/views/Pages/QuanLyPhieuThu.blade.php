  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light" id="myTable">
        ...
        <tbody>
        @foreach ($DanhSachPhieuThu as $key => $get)   
          <tr>
            <td><label class="i-checks m-b-none" name="post[]"></label></td>
            ...
            <td>
                <a href="" data-toggle="modal" data-target="#ChiTietPhieuThu{{$get->idPhieuThu}}">
                ...
                @endif
                <a href="{{URL::to('Home/User/quan-ly-phieu-thu/print-phieu-thu/'.$get->idPhieuThu)}}">
    ...
    @foreach ($DanhSachPhieuThu as $key => $get) 
    <div class="modal fade bd-example-modal-lg" id="ChiTietPhieuThu{{$get->idPhieuThu}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="row">
        ...
        <img src="{{asset('public/uploads/')}}/{{$get->HinhAnhThu}}"height="300"width="270">
          <p class="help-block">Example block-level help text here.</p>
