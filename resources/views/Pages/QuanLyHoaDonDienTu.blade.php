    ...
    <table class="table table-striped b-t b-light">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputHoVaTen">Mã Thuế Hóa Đơn Điện Tử</label>
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light" id="myTable">
        ...
        <tbody>
        @foreach ($DanhSachHoaDonDienTu as $key => $get)
          ...
          <tr>
            ...
            <td>
                <a href="" data-toggle="modal" data-target="#ChiTietHoaDonDienTu{{$get->idHoaDonDienTu}}">
                ...
                @endif
                <a href="{{URL::to('Home/User/quan-ly-hoa-don-dien-tu/print-hoa-don-dien-tu/'.$get->idHoaDonDienTu)}}">
    ...
    @foreach ($DanhSachHoaDonDienTu as $key => $get)
    <div class="modal fade bd-example-modal-lg" id="ChiTietHoaDonDienTu{{$get->idHoaDonDienTu}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group">
          ...
          <img src="{{asset('public/uploads/')}}/{{$get->HinhAnhDienTu}}"height="300"width="270">
          <p class="help-block">Example block-level help text here.</p>
        ...
        <div class="col-md-8">
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Ngày Lập</label>
              <input type="Date" value="{{$get->NgayLap}}" name="NgayLap"  placeholder=".col-md-5" class="form-control" disabled>
          </div>
          <div class="col-md-6 form-group">
              <label for="exampleInputHoVaTen">Tên Đơn Vị</label>
              <input type="text" value="{{$get->TenDonVi}}" name="TenDonVi" placeholder=".col-md-3" class="form-control" disabled>
          </div>
          <div class="col-md-6 form-group">
              <label for="exampleInputHoVaTen">Địa Chỉ</label>
              <input type="text" value="{{$get->DiaChi}}" name="DiaChi" placeholder=".col-md-3" class="form-control" disabled>
          </div>
          <div class="col-md-4 form-group">
              <label for="exampleInputHoVaTen">Mã Số Thuế Điện Tử</label>
              <input type="text" value="{{$get->MaSoThueDienTu}}" name="MaSoThueDienTu" placeholder=".col-md-3" class="form-control" disabled>
          </div>
          <div class="col-md-4 form-group">
              <label for="exampleInputHoVaTen">Số Hợp Đồng</label>
              <input type="text" value="{{$get->SoHopDong}}" name="SoHopDong" placeholder=".col-md-3" class="form-control" disabled>
          </div>
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Ký Cước</label>
              <input type="Date" value="{{$get->KyCuoc}}" name="KyCuoc"  placeholder=".col-md-5" class="form-control" disabled>
          </div>
          <div class="col-md-6 form-group">
              <label for="exampleInputDiaChi">Đơn Vị Khách Hàng</label>
              <select name="DonViKH" class="form-control input-md m-bot15" disabled>
                @foreach ($DanhSachKhachHang as $key => $item)
                <option value="{{$item->idKhachHang}}">{{$item->DonViKH}}</option>
                @endforeach
              </select>
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Liên Hệ Khách Hàng</label>
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Số Tài Khoản KH</label>
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Liên Hệ Công Ty</label>
          ...
          <div class="col-md-4 form-group">
              <label for="exampleInputDiaChi">Hình Thức Tính Tiền</label>
