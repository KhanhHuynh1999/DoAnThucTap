    ...
    <table class="table table-bordered b-t b-light">
        ...
        <tbody>
          <tr>
            ...
            <td><b>{{$TongPhieuChi}} Phiếu</b></td>
            <td><b>{{$TongPhieuThu}} Phiếu</b></td>
            <td><b>{{$TongHoaDonDienTu}} Phiếu</b></td>
            <td><b>{{number_format($DanhSachPhieuChi->sum('TongThanhTien'))}} VND</b></td>
            <td><b>{{number_format($DanhSachPhieuThu->sum('TongCongThanhTien'))}} VND</b></td>
            <td><b>{{number_format($DanhSachHoaDonDienTu->sum('Cong'))}} VND</b></td>
            <td><b>{{number_format($DanhSachPhieuThu->sum('TongCongThanhTien') - $DanhSachPhieuChi->sum('TongThanhTien'))}} VND</b></td>
          </tr>
        </tbody>
      </table>
